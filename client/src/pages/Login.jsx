...
const Login = () => {
  ...
  const handleSuccess = (data) => {
    toast.success(`Login successful! Duration: ${data.duration}ms`);
    navigate('/dashboard');
  };
      ...
      <div className="min-h-screen flex items-center justify-center px-6 pt-20 pb-12 relative z-10">
        <div className="w-full max-w-md">
          <div className="bg-[#1a1a1a] border border-gray-800 rounded-lg p-8 shadow-2xl">
            ...
            <p className="text-center text-gray-400 mb-8 text-sm">Pilih metode autentikasi Anda</p>
            ...
            {/* Auth Content */}
            <div className="mb-6">{activeTab === 'password' ? <PasswordAuth mode="login" onSuccess={handleSuccess} /> : <WebAuthnAuth mode="login" onSuccess={handleSuccess} />}</div>

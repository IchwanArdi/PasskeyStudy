        ...
        <div className="px-5 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-4">
          {layananList.map((item) => (
            <Link
              ...
              className="group relative bg-[var(--card-bg)] border border-[var(--card-border)] rounded-[24px] p-6 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300 overflow-hidden"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="self-center">
                  <ChevronRight className="w-5 h-5 text-[var(--text-muted)] group-hover:text-blue-400 group-hover:translate-x-1 transition-all" />
                </div>
              </div>
            </Link>
          ))}

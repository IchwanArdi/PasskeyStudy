    ...
    return (
      <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-gray-500">Memuat profil admin...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] font-sans pt-12 md:pt-0 pb-24 px-6 md:px-0 transition-colors duration-300">
      <div className="max-w-5xl mx-auto">
        <div className="mb-10 border-b border-[var(--card-border)] pb-8">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-red-500/[0.08] border border-red-500/20 rounded-full text-red-400 text-[10px] font-bold uppercase tracking-wider mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl text-sm focus:outline-none focus:border-red-500/50 focus:ring-1 focus:ring-red-500/20 transition-all"
                    />
                  </div>
                  <div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <button type="submit" className="px-5 py-2.5 bg-red-600 hover:bg-red-500 !text-white rounded-xl text-sm font-semibold transition-all flex items-center gap-2 shadow-lg shadow-red-500/20">
          ...
          <div className="space-y-6">
            <div className="bg-red-500/[0.06] border border-red-500/15 p-6 rounded-2xl">
              <h3 className="text-xs font-semibold text-red-400 mb-4 uppercase tracking-widest">Keamanan Admin</h3>
              <div className="space-y-3">

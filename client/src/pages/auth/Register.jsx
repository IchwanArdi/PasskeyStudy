...
const Register = () => {
    ...
    return (
      <div className="min-h-screen bg-(--bg) text-(--text) font-sans flex items-center justify-center p-6 transition-colors duration-300 relative overflow-hidden">
        <div className="fixed inset-0 z-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-emerald-500/5 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          <div className="glass-card rounded-3xl p-6 sm:p-8">
            {/* Box Peringatan */}
            <div className="p-3.5 bg-yellow-500/6 border border-yellow-500/10 rounded-xl mb-5 flex gap-3">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-[11px] text-gray-500 leading-relaxed font-medium">
                  Kode ini adalah <b className="text-(--text) font-bold">satu-satunya cara</b> memulihkan akun jika perangkat Anda hilang. Setiap kode hanya bisa dipakai 1x.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-2 mb-4">
              ...
              <button onClick={handleDownloadCodes} className="flex-1 py-3 bg-(--card-bg) border border-(--card-border) text-(--text) rounded-xl text-[11px] font-bold hover:opacity-80 transition-all flex items-center justify-center gap-2">
  ...
  return (
    <div className="min-h-screen text-(--text) font-sans flex flex-col items-center justify-center px-6 relative overflow-hidden transition-colors duration-300">
      <div className="relative z-10 w-full max-w-sm">
